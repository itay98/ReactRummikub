const users = {}, { createGame } = require('./controllers/games');
const pointRate = { 3: 1, 10: 0.9, 32: 0.875, 100: 0.85 };
const { drawTile, setRackWithTiles, checkBoard } = require('./utils/game');
const { updateBalance } = require('./controllers/users'), port = 4001;
